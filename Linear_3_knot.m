...
fprintf('--------------------------------------------------------------\n');
fprintf('      Nilai GCV untuk 3 titik knot pada spline linear\n');
fprintf('--------------------------------------------------------------\n');
...
%Matriz y1 dan y2
my1=[m1,X1,xk11,xk12,xk13,X2,xk21,xk22,xk23,X3,xk31,xk32,xk33];
my2=[m1,X1,xt11,xt12,xt13,X2,xt21,xt22,xt23,X3,xt31,xt32,xt33];
